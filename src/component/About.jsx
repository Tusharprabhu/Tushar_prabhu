...
const About = () => {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      // Updated selector for the new Tailwind structure
      ...
      <div className="flex flex-wrap lg:mt-32">
        <div className="about-image w-full lg:w-1/2 lg:p-8">
          <div className="flex items-center justify-center h-full max-w-full overflow-hidden">
            <div className="parallax-container relative overflow-hidden w-[80vw] h-[80vh] lg:w-[40vw] lg:h-[80vh] rounded-2xl bg-gray-800 mx-auto lg:mx-0">
              <img 
                className="absolute -top-[10%] left-0 w-full h-[120%] object-cover rounded-2xl block will-change-transform origin-center" 
                src={aboutImg} 
                alt="about"
              />
            </div>

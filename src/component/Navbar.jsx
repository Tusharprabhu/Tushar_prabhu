...
const navbar = () => {
  return (
    <nav className="sticky top-0 z-50 bg-black/90 backdrop-blur-md pt-7 pb-4 lg:px-5 flex item-center justify-between border-b border-neutral-800/30">
      ...
      <div className="m-0 flex items-center justify-center gap-4 text-2xl">
        ...
        <a href="https://www.instagram.com/tu_shaar2.0/" className="text-white hover:text-pink-600">
          <FaInstagram />
        </a>
